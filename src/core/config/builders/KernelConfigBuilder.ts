...
export class KernelConfigBuilder {
  ...
  public configureRetry(
    config: Partial<
      Omit<RetryConfig, "maxAttempts" | "initialDelay" | "maxDelay" | "timeout">
    > &
      Pick<
        RetryConfig,
        "maxAttempts" | "initialDelay" | "maxDelay" | "timeout"
      >,
  ): this {
  ...
  public configureBulkhead(
    config: Partial<
      Omit<BulkheadConfig, "maxConcurrent" | "maxQueued" | "timeout">
    > &
      Pick<BulkheadConfig, "maxConcurrent" | "maxQueued" | "timeout">,
  ): this {
  ...
  public configureErrorHandler(
    console: Partial<Omit<ConsoleHandlerConfig, "enabled">> &
      Pick<ConsoleHandlerConfig, "enabled">,
    file?: Partial<Omit<FileHandlerConfig, "enabled" | "path">> &
      Pick<FileHandlerConfig, "enabled" | "path">,
  ): this {
