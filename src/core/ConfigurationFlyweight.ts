...
export class ConfigurationFlyweightFactory {
    ...
    static setConfiguration(key: string, value: any, metadata: Record<string, any> = {}): void {
...
export class ConfigurationManager {
    ...
    getValue(key: string, defaultValue?: any): any {
        ...
        const config = ConfigurationFlyweightFactory.getConfiguration(key, defaultValue);
        return config.value;
    }
