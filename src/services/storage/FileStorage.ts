...
class FileDatabase {
    ...
    private constructor(filePath: string, strategy: SerializationStrategy = 'json') {
    ...
    // Patrón Singleton
    public static getInstance(filePath?: string, strategy?: SerializationStrategy): FileDatabase {
    ...
    private createSerializationStrategy(strategy: SerializationStrategy): ISerializationStrategy {
        switch (strategy) {
            case 'json':
            ...
            if (fs.existsSync(this.filePath)) {
                ...
                if (fileContent.trim()) {
                    ...
                    for (const [name, collectionData] of Object.entries(data)) {
                        const collection = new Collection<any>(name, this.observer, collectionData as any[]);
