...
import { ConfigEventManager, ConfigChangeEventType } from '../../../../src/core/config/events/ConfigEventManager';
...
describe('ConfigLoaderMediator', () => {
    ...
    describe('Configuration Loading', () => {
        ...
        it('should throw error when loader not found', async () => {
            await expect(mediator.loadConfig('non-existent')).rejects.toThrow('Config loader not found');
        });
    });
    ...
    describe('Event Management', () => {
        it('should register event hooks', () => {
            ...
            expect(eventManager.hasListeners(ConfigChangeEventType.CONFIG_LOADED)).toBeTruthy();
        });
    });
});
