...
import { DEFAULT_BULKHEAD_CONFIG, DEFAULT_CIRCUIT_BREAKER_CONFIG, DEFAULT_PLUGIN_CONFIG, DEFAULT_RETRY_CONFIG } from '../../../src/core/config/defaults';
...
describe('ValidatorFactory', () => {
    ...
    describe('createCustomChain', () => {
        ...
        it('should skip unknown validator types', () => {
            const chain = ValidatorFactory.createCustomChain(['retry', 'unknown', 'bulkhead']);
            expect(chain).toBeInstanceOf(ValidationChain);
        });
    });
