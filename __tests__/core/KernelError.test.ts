...
describe("KernelError", () => {
  ...
  describe("details handling", () => {
    it("should store primitive details", () => {
      const primitives = ["string detail", 42, true, null, undefined];
  ...
  describe("timestamp behavior", () => {
    ...
    it("should have different timestamps for different instances", async () => {
      ...
      expect(error2.timestamp.getTime()).toBeGreaterThan(
  ...
  describe("comparison and equality", () => {
    ...
    it("should have different timestamps for different instances", async () => {
      ...
      expect(error1.timestamp.getTime()).not.toEqual(
        error2.timestamp.getTime(),
      );
    });
  });
  ...
  describe("edge cases and error conditions", () => {
    ...
    it("should handle special characters in message", () => {
      const specialMessage =
        "Error with 特殊字符 and émojis 🚨 and newlines\n\ttabs";
