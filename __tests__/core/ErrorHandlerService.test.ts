import { ErrorHandlerService, ErrorHandler } from '../../src/core/ErrorHandlerService';
...
describe('ErrorHandlerService', () => {
    ...
    describe('edge cases and error conditions', () => {
        it('should handle null error gracefully', async () => {
            await expect(errorHandlerService.handleError(null as any)).rejects.toThrow();
        });

        it('should handle undefined error gracefully', async () => {
            await expect(errorHandlerService.handleError(undefined as any)).rejects.toThrow();
        });
